...
//! prefix strings.
//!
//! Only covers grouped prefix sets used in `callback_router::handle_menu_callback`
//! top-level dispatch; single-prefix `else if` arms further down still match on raw
//! strings to limit blast radius of this refactor.
...
mod tests {
    ...
    fn returns_none_for_unknown() {
        assert_eq!(CallbackKind::parse("dl:mp3:abc"), None);
        assert_eq!(CallbackKind::parse("lyr:toggle:1"), None);
