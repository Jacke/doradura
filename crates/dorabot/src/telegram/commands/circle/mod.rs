...
// Circle/cut command parsing — extracted to keep this module focused on
// the ffmpeg-orchestration / Telegram-side workflow. Re-exported so
// existing call sites (`commands::parse_*`, `commands::CutSegment`)
// continue working unchanged.
pub mod parser;
pub use parser::*;

// Audio-cut pipeline (Phase 2 split). Self-contained — uses build_cut_filter
// from this module + standard Telegram/storage/config imports.
pub mod audio_cut;
pub use audio_cut::process_audio_cut;
