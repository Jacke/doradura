...
use crate::download::metadata::{
    ...
    has_both_video_and_audio, probe_duration_seconds, probe_video_metadata,
};
...
mod download_tests {
    use super::*;
    use crate::core::{extract_retry_after, is_timeout_or_network_error};
    use crate::download::metadata::validate_cookies_file_format;
